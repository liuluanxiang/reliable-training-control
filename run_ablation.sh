...
python run_experiment.py --config configs/ablation_cifar10_resnet18.json --results-dir "$RESULTS_DIR" --experiment-suffix "$EXPERIMENT_SUFFIX" --existing error --progress batch --progress-log "$PROGRESS_LOG" --progress-state results/progress_state.json --dashboard-path results/progress_dashboard.html
