...
python run_experiment.py --config configs/cifar10_resnet18_main.json
python run_experiment.py --config configs/cifar100_resnet18_main.json
python run_experiment.py --config configs/cifar10_resnet50_supplement.json
python run_experiment.py --config configs/cifar100_resnet50_supplement.json
python run_experiment.py --config configs/cifar10_vgg16_supplement.json
